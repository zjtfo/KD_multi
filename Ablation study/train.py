...
#             loss = loss_ce.mean() + multihop_kd_weight * transfer_multihop_loss_ce.mean() + logical_kd_weight * transfer_logical_loss_ce.mean()
...
#     parser.add_argument('--output_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_self_distillation/output/checkpoint')

#     parser.add_argument('--save_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_self_distillation/log', help='path to save checkpoints and logs')
...
#     # input and output
#     parser.add_argument('--input_dir', default='./Multi_Teacher_In_Questions/preprocessed_data_next')
#     parser.add_argument('--output_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_circle_generation/output/checkpoint')

#     parser.add_argument('--save_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_circle_generation/log', help='path to save checkpoints and logs')
#     parser.add_argument('--model_name_or_path', default='./bart-base')
#     parser.add_argument('--ckpt')
...
def train(args):
    ...
    for _ in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_loader):
            ...
            loss = loss_ce.mean() + args.kd_weight * rep_loss + args.kd_weight * transfer_multihop_loss_ce.mean() + args.kd_weight * transfer_logical_loss_ce.mean()
...
def main():
    ...
    # input and output
    parser.add_argument('--input_dir', default='./Multi_Teacher_In_Questions/preprocessed_data_next')
    parser.add_argument('--output_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_confidence_aware/output/checkpoint')

    parser.add_argument('--save_dir', default='./Multi_Teacher_In_Questions/ablation_study/ablation_without_confidence_aware/log', help='path to save checkpoints and logs')
    parser.add_argument('--model_name_or_path', default='./bart-base')
    parser.add_argument('--ckpt')
