...
def train(args):
    ...
    vocab_json = os.path.join(args.input_dir, 'verify_vocab.json')
    train_pt = os.path.join(args.input_dir, 'verify_train.pt')
    val_pt = os.path.join(args.input_dir, 'verify_val.pt')
...
def main():
    ...
    parser.add_argument('--output_dir', default='./Multi_Teacher_In_Questions/verify_kopl/output/checkpoint')

    parser.add_argument('--save_dir', default='./Multi_Teacher_In_Questions/verify_kopl/log', help='path to save checkpoints and logs')
