...
def main():
    ...
    parser.add_argument('--input_dir', default='./Multi_Teacher_In_Questions/preprocessed_data')
    parser.add_argument('--output_dir', default='./Multi_Teacher_In_Questions/preprocessed_data_next')
